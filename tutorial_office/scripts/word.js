...
define("third_party/domready/domReady", [], function () {
    ...
    var c,
        a,
        e,
        g = "undefined" !== typeof window && window.document,
        h = !g,
        k = g ? document : null,
        m = [];
    if (g) {
...
define("qowtRoot/utils/typeUtils", [], function () {
    ...
    var b = {
            checkArgTypes: function (a, c) {
                for (var b in c) {
                    var h = { value: c[b][0], types: c[b].slice(1) };
                    d(a, b, h);
                }
            },
            isObject: function (a) {
                ...
                var b = function () {},
                    d = {
                        ...
                        markAsType: function (a) {
                            Object.defineProperty(a, "constructor", { value: b, configurable: !1, writable: !1, enumerable: !1 });
                            return a;
                        },
                    };
                if (a) {
...
(function () {
    var d = {},
        b = window.sessionStorage.getItem("featureOverrides");
    b && (d = JSON.parse(b));
    d.isRelease = !0;
    d.edit = !1;
...
define("qowtRoot/features/pack", [], function () {
    return { edit: !0, save: !1, pointEdit: !1, hats: !0 };
});
        ...
        return function (b) {
            ...
            c.all = function (a) {
                ...
                var b = new n(),
                    ...
                    f,
                    u;
                for (f = 0; f < d; ++f) f in a ? ((u = a[f]), q(u) ? c(b, h, k(u), f) : ((h[f] = u), --e)) : --e;
                0 === e && b.resolve(h);
                return new g(b);
            };
            c.race = function (a) {
            ...
            n.prototype.run = function () {
                var a = this.consumers,
                    c = (this.handler = this.handler.join());
    ...
    d("qowtRoot/third_party/when/lib/Queue", [], function () {
        ...
        b.prototype._ensureCapacity = function (b) {
            var a = this.head,
                ...
                h = 0,
                k;
            if (0 === a) for (k = this.length; h < k; ++h) g[h] = d[h];
            else {
                b = d.length;
...
(function (d) {
    d("qowtRoot/third_party/when/lib/async", ["require"], function (b) {
        ...
        return "undefined" !== typeof process && null !== process && "function" === typeof process.nextTick
            ...
            : (c = ("function" === typeof MutationObserver && MutationObserver) || ("function" === typeof WebKitMutationObserver && WebKitMutationObserver))
            ? (function (a, b) {
                  var c,
...
(function (d) {
    d("qowtRoot/third_party/when/lib/Promise", ["require", "./makePromise", "./scheduler", "./async"], function (b) {
        var c = b("./makePromise"),
            a = b("./scheduler");
        b = b("./async");
        return c({ scheduler: new a(b), monitor: "undefined" !== typeof console ? console : void 0 });
    });
})(
    "function" === typeof define && define.amd
        ? define
...
(function (d) {
    d("qowtRoot/third_party/when/when", "require ./lib/timer ./lib/timed ./lib/array ./lib/flow ./lib/inspect ./lib/iterate ./lib/progress ./lib/with ./lib/Promise".split(" "), function (b) {
        ...
        var k = b("./lib/timer"),
            ...
            v = b("./lib/with"),
            f = b("./lib/Promise"),
            f = [l, t, x, z, n, v].reduceRight(function (a, b) {
                return b(a);
            }, m(k.set, k.clear, f)),
            r = f.resolve,
...
define("qowtRoot/utils/promiseUtils", ["qowtRoot/utils/typeUtils", "qowtRoot/third_party/when/when"], function (d, b) {
    var c = {
        ...
        throwAndEscapeChain: function (a) {
            a instanceof Error || (console.error("throwAndEscapeChain wrapping value in new Error: ", a), (a = Error(a)));
            b.reject(a).done();
            throw a;
        },
        pipeline: function (a) {
            function b() {
                for (var h = Array.prototype.slice.call(arguments, 0); 0 < a.length; ) {
                    var m = a.shift();
                    if (d.isPromiseLike(m))
                        return c.cast(m).then(function (c) {
                            a.unshift(c);
                            return b.apply(g, h);
                        });
                    d.checkArgTypes("PromiseUtils.pipeline", { task: [m, "function"] });
                    m = m.apply(g, h);
                    if (d.isPromiseLike(m))
                        return c.cast(m).then(function (a) {
                            return b(a);
                        });
                    h = [m];
                }
            ...
            if (h.some(d.isPromiseLike))
                return Promise.all(h).then(function (a) {
                    return c.pipeline.apply(g, a);
                });
            d.checkArgTypes("PromiseUtils.pipeline", { tasks: [a, "list"] });
            a = a.slice(0);
...
define("utils/analytics/googleAnalytics", ["qowtRoot/features/utils", "qowtRoot/utils/promiseUtils"], function (d, b) {
    function c(b, c) {
        var e;
        void 0 !== f
            ? (e = f ? Promise.resolve() : Promise.reject(Error("ga permission cached (not permitted)")))
            : (window.analytics && chrome && chrome.metricsPrivate && chrome.metricsPrivate.getIsCrashReportingEnabled && (!d.isDebug() || void 0 !== window.__gaMock)
                  ? (e = Promise.resolve())
                  : (console.warn("GA not supported on this platform"), (e = Promise.reject(Error("GA not supported on this platform")))),
              (e = e.then(a).catch(h)));
        return e
            .then(k)
            .then(b.bind(null, c))
    ...
    var x = { word: "UA-44583639-1", sheet: "UA-44583639-2", point: "UA-44583639-3", QO: "UA-44583639-4" },
        z = "Quickoffice",
        v,
        f,
        r,
...
function createOption(d, b) {
    ...
    a.textContent = d;
    a.href = "#";
    c.addEventListener("click", onClick, !0);
    return c;
}
function onClick(d) {
    var b;
    "word" === d.target.id
        ...
        : "sheet" === d.target.id && (b = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
    chrome.windows.getCurrent(function (c) {
        chrome.runtime.sendMessage({ newCreate: d.target.id, mimeType: b, currentWindowId: c.id }, function () {
            window.close();
        });
    });
}
